var module_13= document.getElementById('second');
var back_btn= document.querySelector('.back_btn');
var new_page_title= document.querySelector('.titlenp');
...
var con_box = document.getElementById("containerItem");
var object_arry = [];
var count = 0;
var plus_icon01 = [];
var trash_icon01 = [];
...
var iteam_btn = document.querySelector(".add_btnn");
var temp_id;
...
var task_plus1 = document.querySelector('.pluss');
